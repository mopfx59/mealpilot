...
function migrateState(state) {
  ...
  for (const recipe of state.recipes) {
    ...
    recipe.personal ??= true; recipe.season ||= 'Toute saison'; recipe.category ||= 'Autre'; recipe.favorite = Boolean(recipe.favorite); recipe.leftoverFriendly ??= !/salade|tartare|soufflé|friture/i.test(`${recipe.title} ${recipe.category}`);
  }
