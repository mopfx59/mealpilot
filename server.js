...
const defaultState = () => ({ recipes: seasonalRecipes(), menu: Object.fromEntries(DAYS.map(day => [day, { lunch: null, dinner: null }])), plan: null, validatedPlan: null, leftovers: [], shopping: [], providers: structuredClone(DEFAULT_PROVIDERS), providerStatus: {}, recipeCache: {}, calendar: { connected: false, calendarId: 'primary', calendarName: 'Agenda principal', calendarIds: ['primary'], calendarNames: { primary: 'Agenda principal' }, events: [], schoolHolidays: [], lastSyncAt: null } });
